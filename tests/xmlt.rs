...
use syncbot::ResourceRef;
use syncbot::wire::{
    FlatClaim, FlatHeartbeat, FlatPlanRoute, FlatRegister, FlatRelease, FlatReply, PlanRouteRequest,
};
...
#[test]
fn flat_plan_route_parses_xml() {
    let xml = r#"<plan>
        <start_node_id>1001</start_node_id>
        <goal_node_id>1003</goal_node_id>
        <use_penalties>true</use_penalties>
    </plan>"#;
    let req: FlatPlanRoute = quick_xml::de::from_str(xml).expect("deserialise");
    assert_eq!(req.start_node_id, "1001");
    assert_eq!(req.goal_node_id, "1003");
    assert!(req.use_penalties);
}

#[test]
fn flat_plan_route_accepts_uuid_and_defaults_penalties() {
    let xml = r#"<plan>
        <start_node_id>11111111-1111-1111-1111-111111111111</start_node_id>
        <goal_node_id>22222222-2222-2222-2222-222222222222</goal_node_id>
    </plan>"#;
    let req: FlatPlanRoute = quick_xml::de::from_str(xml).expect("deserialise");
    assert_eq!(req.start_node_id, "11111111-1111-1111-1111-111111111111");
    assert!(!req.use_penalties);
}
